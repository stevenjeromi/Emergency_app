...
class serviceresetpasswd extends StatefulWidget {
  serviceresetpasswd({super.key, required this.check});
  int check;
  @override
  State<serviceresetpasswd> createState() => _serviceresetpasswdState();
}

class _serviceresetpasswdState extends State<serviceresetpasswd> {
